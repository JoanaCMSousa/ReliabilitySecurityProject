...
public class SecurityHandler {
	...
	public void decryptWithPassword (String filename) throws Exception{
    	...
    	fis = new FileInputStream(result[0]+".cif");
    	fos = new FileOutputStream(result[0] + "2." + result[1]);
	...
	public void hash(String filename) throws Exception {
		...
		FileOutputStream fos = new FileOutputStream(result[0] + ".hash");
	...
	public int checkHash(String filename) throws Exception{
		
		String[] result = filename.split("\\.");
		
		//FileInputStream fis = new FileInputStream(result[0] + ".hash");
		File fileHash = new File(result[0] + ".hash");
		...
		FileOutputStream fos = new FileOutputStream(result[0] + "1.hash");
		MessageDigest md = MessageDigest.getInstance("SHA-256");
		ObjectOutputStream oos = new ObjectOutputStream(fos);
		...
		File fileHash1 = new File(result[0] + "1.hash");
		//ObjectInputStream ois = new ObjectInputStream(fis);
