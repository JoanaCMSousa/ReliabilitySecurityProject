...
public class repCatalog{
	...
	//TODO: MAIS IMPORTANTE A FAZER
	  ...
	  */
	public boolean hasAccess(String repName, String userToLook,SecurityHandler sc) throws IOException{
	 ...
	 * @return
	 */
	private boolean hasAccess(File file,String repName,String user,SecurityHandler sc){
		try {
			System.out.println("repName: " + repName);
			sc.decryptFile(file);
